...
export default class PortfolioWorkExperience extends LightningElement {
    ...
    @wire(getRelatedListRecords, {
        ...
        if(error){
            console.error('Error occured while fetching work experience => ',JSON.stringify(error))
        }
    }
    ...
    formatExperience(data){
        ...
        console.log('Work Experience List => ',JSON.stringify(this.workExperienceList))
    }
    getValue(data) {
